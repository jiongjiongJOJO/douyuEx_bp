...
// ==/UserScript==
"use strict";function init(){initPkg_Shield_RemoveRepeatedDanmaku_ScriptHook(),initScriptHook(),initPkg_Night_Set_Fast(),initResponseHook(),initPkg_ShowDanmaku(),Update_checkVersion(),initKillP2P(),initFullScreen(),initHighestVideoQuality(),removeAD(),initPkg_Statistics(),initPkg_Console(),initPkg_Menu(),initPkg_FollowList()}function initPkg(){initPkg_DanmakuTail(),initPkg_Night(),initPkg_ExIcon(),initPkg_ExPanel(),initPkg_RealAudience(),initPkg_CopyRealLive(),initPkg_AudioLine(),initPkg_RemoveAD(),initPkg_Shield(),initPkg_BagInfo(),initPkg_Update(),initPkg_AutoAnchorStar(),initPkg_Fkbuff(),initPkg_Monitor(),initPkg_Lottery(),initPkg_PopupPlayer(),initPkg_LiveTool(),initPkg_VideoTools(),initPkg_ExpandTool(),initPkg_Refresh(),initPkg_BarrageLoop(),initPkg_FansContinue(),initPkg_Sign(),initPkg_BarragePanel(),initPkg_AccountList(),initPkg_ChatTools(),initPkg_MonthCost(),initPkg_RoomVip(),initPkg_WeeklyPanel(),initPkg_DanmakuCollect(),initPkg_RestoreYuba(),initPkg_ChangeDanmakuLengthLimit(),initPkg_CheckAnchorPocket(),initPkg_LastLiveTime(),initPkg_VolumeMouseScrolling()}function initPkg_Timer(){initPkg_LevelTask_Timer(),initPkg_Sign_OPFOY_Timer(),initPkg_DisableCloseJump_Timer()}function initTimer(){initPkg_Timer()}function initStyles(){var e=document.createElement("style");e.appendChild(document.createTextNode(`
...
.layui-timeline-title {
    ...
    `,e.appendChild(t))}function setSearchBarrageButton(e){var t;null==document.getElementById("barragePanel__search")&&((t=document.createElement("div")).className="button-7e1395",t.innerText="查弹幕",t.id="barragePanel__search",t.style="z-index:5",e.appendChild(t))}function setReplyBarrageButton(e){var t;null==document.getElementById("barragePanel__reply")&&((t=document.createElement("div")).className="button-7e1395",t.innerText="回复",t.id="barragePanel__reply",t.style="z-index:5",e.appendChild(t))}function setBarrgePanelFunc(e,o){document.getElementById("barragePanel__reply").onclick=()=>{var e=document.getElementsByClassName("danmuContent-25f266")[0].innerText,t=document.getElementsByClassName("ChatSend-txt")[0],e=`@${o}：`+e;"TEXTAREA"==t.tagName?t.value=e:t.innerText=e,t.focus()},document.getElementById("barragePanel__mute").onclick=async()=>{var e=document.getElementById("barragePanel__muteSelect").value||"1",t=await addMuteUser(rid,o,e);"添加成功"==t.msg?showMessage(`【禁言】${o}已被禁言${e}分钟`,"success"):showMessage(t.msg,"error")},document.getElementById("barragePanel__search").onclick=async()=>{var e=await getUserUid(o);""!==e&&openPage(`https://www.doseeing.com/data/fan/${e}?type=chat&dt=0`,!0)}}function insertBarragePanel_SearchBarrage_Dom(e){var t=parseInt(e.style.marginLeft);let o="-237px";o=237<t?"-237px":"237px";t=document.createElement("div");t.className="barragePanel__funcPanel",t.style="margin-left:"+o,t.innerHTML=`
    <ul class="layui-timeline" id="barragePanel__searchPanel">
        
    </ul>
    `,e.insertBefore(t,e.childNodes[0])}function getUserRecentBarrage(e){return new Promise(t=>{GM_xmlhttpRequest({method:"GET",url:"http://dyapi.fz996.com/api/Wx/GetDataBarrage?keyword="+e,responseType:"json",headers:{"Content-Type":"application/x-www-form-urlencoded"},onload:function(e){e=e.response;t(e)}})})}function getUserUid(n){return new Promise(o=>{GM_xmlhttpRequest({method:"GET",url:"https://www.doseeing.com/api/suggest_all?type=room&nickname="+encodeURIComponent(n),responseType:"json",headers:{"Content-Type":"application/x-www-form-urlencoded"},onload:function(e){e=e.response;let t=!0;e.suggest||(t=!1),e.suggest.fan||(t=!1),0===e.suggest.fan.length&&(t=!1),(t=e.suggest.fan[0].nickname!==n?!1:t)?o(e.suggest.fan[0].user_id):o("")}})})}function initPkg_BarragePanel_Tip(){setBarragePanelTipCallBack()}function setBarragePanelTipCallBack(){new DomHook("#comment-dzjy-container",!1,e=>{e.length<=0||e[0].addedNodes.length<=0||(renderBarragePanelTip(),setBarragePanelTipFunc())})}function renderBarragePanelTip(){let e=document.createElement("div");e.style.display="inline-block";var t=document.getElementsByClassName("labelfisrt-407af4");0!==t.length&&((t=t[0].parentElement).appendChild(e),(e=document.createElement("p")).className="sugun-e3fbf6",e.innerText="|",t.appendChild(e),(e=document.createElement("div")).className="labelfisrt-407af4 thirdBtn-06cde5 fourBtn-0845d4",e.id="barrage-panel-tip__+1",e.innerText="+1",t.appendChild(e))}function setBarragePanelTipFunc(){document.getElementById("barrage-panel-tip__+1").onclick=()=>{var e=document.getElementById("comment-higher-container");0<e.getElementsByClassName("ex-image-danmaku").length?sendBarrage(e.getElementsByClassName("text-879f3e")[0].innerHTML.replace(/<a[^>]*><img\s+(?:.*?\s+)?src="(.*?)"[^>]*?\/?><\/a>/g,(e,t)=>getImageDanmakuFromImgSrc(t))):sendBarrage(e.innerText)}}let barrageMemoryArr=[],barrageMemoryIndex=0,prevTextareaPosition=0;function initPkg_ChatMemory(){initPkg_ChatMemory_Func()}function initPkg_ChatMemory_Func(){document.getElementsByClassName("ChatSend-txt")[0].addEventListener("keydown",e=>{var t=e.target,o="TEXTAREA"===t.tagName;38==e.keyCode?0==getTextareaPosition(t)&&(barrageMemoryIndex=0<barrageMemoryIndex?barrageMemoryIndex-1:barrageMemoryIndex,chatMemory_setBarrage()):40==e.keyCode?(o=(o?t.value:t.innerText).length,getTextareaPosition(t)==o&&(barrageMemoryIndex=barrageMemoryIndex<barrageMemoryArr.length-1?barrageMemoryIndex+1:barrageMemoryIndex,chatMemory_setBarrage())):13==e.keyCode&&chatMemory_pushBarrage(getBarrageValue())}),document.getElementsByClassName("ChatSend-button")[0].addEventListener("click",()=>{chatMemory_pushBarrage(getBarrageValue())})}function chatMemory_pushBarrage(e){barrageMemoryIndex=barrageMemoryArr.push(e)}function chatMemory_setBarrage(){null!=barrageMemoryArr[barrageMemoryIndex]&&setBarrageValue(barrageMemoryArr[barrageMemoryIndex]||"")}function getBarrageValue(){var e=document.getElementsByClassName("ChatSend-txt")[0];return null!=e?"TEXTAREA"===e.tagName?e.value:e.innerText:""}function setBarrageValue(e){var t=document.getElementsByClassName("ChatSend-txt")[0];null!=t&&("TEXTAREA"===t.tagName?t.value=e:t.innerText=e)}function initPkg_ChatTools(){initPkg_ChatMemory()}let anchorPocketData={t:0,list:[]};async function initPkg_CheckAnchorPocket(){await updateAnchorPocketData(),new DomHook(".FansMedalPanel-enter",!1,async e=>{var t,o,n=document.querySelector(".FansMedalInfo-head");n&&(t=(new Date).getDate(),new Date(anchorPocketData.t).getDate()<t&&await updateAnchorPocketData(),0!==(t=anchorPocketData.list).length)&&((o=document.createElement("div")).innerHTML=`
    ...
    `,n.appendChild(o))})}async function updateAnchorPocketData(){var e=await getAnchorPocketList(rid);anchorPocketData.list=e,anchorPocketData.t=(new Date).getTime()}async function getAnchorPocketList(o){return new Promise((t,e)=>{fetch("https://www.douyu.com/japi/interact/cdn/pocket/effective?rid="+o,{method:"GET",mode:"no-cors",credentials:"include"}).then(e=>e.json()).then(e=>{if(!e.data)return t([]);t(e.data.list)}).catch(e=>{console.log("请求失败!",e)})})}function initPkg_Console(){console_watermark_douyEx()}function console_watermark_douyEx(){console.log(`%c
   ______                    _____)
  (, /    )                /
    /    / ___             )__   __/
...
%cver `+curVersion,"color:rgb(255,121,35);font-size:20px;font-weight:bold;","color:red;font-size:16px;")}function initPkg_CopyRealLive(){initPkg_CopyRealLive_Dom(),initPkg_CopyRealLive_Func()}function initPkg_CopyRealLive_Dom(){CopyRealLive_insertIcon()}function CopyRealLive_insertIcon(){var e=document.createElement("div");e.className="Title-blockInline",e.id="copy-real-live",e.innerHTML='<div class="TitleShare"><div class="TitleShare-shareBox "><div class="Title-row-span is-right"><span class="Title-row-icon "><svg t="1585641756842" class="icon" viewBox="0 0 1237 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5646" width="16" height="16"><path d="M648.448 946.347l0.256-1.622-0.256 1.622z m84.31 13.354c-0.769 4.608-0.769 4.608-4.182 13.483-8.533 16.768-8.533 16.768-49.835 22.784-24.149-14.293-24.149-14.293-27.605-22.613-2.475-5.718-2.475-5.718-3.541-9.387L476.416 335.36l-103.083 499.2c-1.109 5.12-1.109 5.12-4.821 13.27-6.827 12.117-6.827 12.117-35.285 22.527-30.294-7.253-30.294-7.253-38.742-19.37-4.522-8.15-4.522-8.15-6.058-13.227l-74.582-262.357H0v-85.334h278.272l45.781 161.11 104.022-503.424c1.024-4.694 1.024-4.694 4.394-12.502 6.102-11.989 6.102-11.989 35.968-23.338 31.83 8.533 31.83 8.533 39.254 20.736 4.053 7.808 4.053 7.808 5.376 12.544l165.888 609.237 113.92-716.885c0.896-5.248 0.896-5.248 4.864-14.592 9.088-15.574 9.088-15.574 44.928-22.4C868.48 12.587 868.48 12.587 873.6 22.443c3.285 6.912 3.285 6.912 4.523 11.52l112 446.549h221.738v85.333H923.563l-78.507-312.917-112.299 706.773z" p-id="5647"></path></svg></span><span class="Title-row-text">复制直播流</span></div></div></div>';let t=document.getElementsByClassName("Title-col")[4];t&&1<t.childNodes.length?t.insertBefore(e,t.childNodes[1]):(t=getValidDom([".subTitleContainer__-vzhr"])).appendChild(e)}function CopyRealLive_getQn(e){return String(e).includes("蓝光8M")?8:String(e).includes("蓝光4M")?4:String(e).includes("超清")?3:String(e).includes("高清")?2:0}function CopyRealLive_copyUrl(e){getRealLive_Douyu(rid,!0,!1,e,e=>{"None"==e?showMessage("房间未开播或其他错误","error"):(e=String(e),GM_setClipboard(e),showMessage("复制成功","success"))})}function initPkg_CopyRealLive_Func(){document.getElementById("copy-real-live").addEventListener("click",function(){0<document.querySelectorAll(".tipItem-898596 > ul > li").length?document.querySelectorAll(".tipItem-898596 > ul > li").forEach(e=>{e.className.includes("selected")&&CopyRealLive_copyUrl(CopyRealLive_getQn(e.innerText))}):CopyRealLive_copyUrl(0)});var e=document.getElementsByClassName("RecommendViewTit-04ebd8");0<e.length&&e[0].innerText}function initPkg_DanmakuCollect(){initPkg_DanmakuCollect_Dom();const t=document.getElementsByClassName("ChatSend-txt")[0],o=document.getElementsByClassName("ChatBarrageCollect")[0];t.addEventListener("keyup",()=>{var e=("string"==typeof t.value?t.value:t.innerText).length;o.style.display=25<e?"none":""}),document.getElementsByClassName("ChatSend-button")[0].addEventListener("click",()=>{o.style.display=""}),responseHook((e,t)=>{if(e.includes("bulletscreen/query"))return(e=JSON.parse(t)).data.list.unshift(...getLocalDanmakuCollect().map(e=>({content:e.content,type:2,id:e.id}))),JSON.stringify(e)}),responseHook((e,t,o)=>{if(e.includes("bulletscreen/add"))return 0==(e=JSON.parse(t)).error?t:(t=JSON.parse(o)["content"],addLocalDanmakuCollect(t),e.msg="收藏成功，云收藏已达上限，将收藏至本地（由DouyuEx插件实现无限收藏）",document.querySelector(".ChatBarrageCollect-tip").click(),document.querySelector(".ChatBarrageCollect-tip").click(),JSON.stringify(e))}),responseHook((e,t,o)=>{e.includes("bulletscreen/del")&&(e=JSON.parse(o)["id"],delLocalDanmakuCollect(e))})}function initPkg_DanmakuCollect_Dom(){let e=setInterval(()=>{void 0!==document.getElementsByClassName("ChatBarrageCollect")[0]&&(clearInterval(e),new DomHook(".ChatBarrageCollect",!1,e=>{var t,o=document.getElementsByClassName("ChatBarrageCollectPop-title");o?0!==o.length&&((t=document.createElement("input")).id="ex-danmaku-collect-search",t.placeholder="搜索弹幕",t.style.marginLeft="6px",o[0].appendChild(t),t.addEventListener("input",searchCollectDanmaku)):document.getElementById("ex-danmaku-collect-search").removeEventListener("input",searchCollectDanmaku)}))},1e3)}function searchCollectDanmaku(e){var t=e.target.value,o=document.getElementsByClassName("ChatBarrageCollectPop-barrageContent")[0].parentElement.getElementsByClassName("TagItem");for(let e=0;e<o.length;e++){var n=o[e];n.innerText.includes(t)?n.style.display="":n.style.display="none"}}function getLocalDanmakuCollect(){let t=localStorage.getItem("ExSave_DanmakuCollect");try{t=JSON.parse(t)||[]}catch(e){t=[]}return t}function addLocalDanmakuCollect(e){var t=getLocalDanmakuCollect();t.unshift({content:e,id:(new Date).getTime()}),localStorage.setItem("ExSave_DanmakuCollect",JSON.stringify(t))}function delLocalDanmakuCollect(t){var e=getLocalDanmakuCollect();localStorage.setItem("ExSave_DanmakuCollect",JSON.stringify(e.filter(e=>e.id!==t)))}function initPkg_DanmakuTail(){initPkg_DanmakuTail_insertDom(),initPkg_DanmakuTail_Set(),initPkg_DanmakuTail_Func()}function initPkg_DanmakuTail_insertDom(){var e=document.createElement("div");e.className="ChatToolBar-DanmakuTail",e.innerHTML='<div class="ChatToolBar-DanmakuTail-tip" title="弹幕小尾巴" ></div>';document.getElementsByClassName("ChatToolBar__left")[0].appendChild(e);var e=document.createElement("div"),t=(e.className="ChatToolBar-DanmakuTail-Panel",document.getElementsByClassName("layout-Player-chat")[0]);t.insertBefore(e,t.childNodes[0]),window.location.href.includes("/beta")||(e.style.bottom="140px"),e.innerHTML=`
    ...
    `}function initPkg_DanmakuTail_Set(){var e=localStorage.getItem("ExSave_DanmakuTail");null!=e&&(e=JSON.parse(e),document.getElementById("DanmakuTail-checkbox").checked=e.isTailEnabled,document.getElementById("DanmakuTail-input").value=e.tailContent||"",document.getElementById("DanmakuTail-input").disabled=e.isTailEnabled,document.querySelectorAll('input[name="DanmakuTailType"]')[0].disabled=e.isTailEnabled,document.querySelectorAll('input[name="DanmakuTailType"]')[1].disabled=e.isTailEnabled,e.type?(document.querySelector(`input[name="DanmakuTailType"][value="${e.type}"]`).checked=!0,saveData_DanmakuTail()):document.querySelector('input[name="DanmakuTailType"][value="2"]').checked=!0,e.isTailEnabled)&&document.querySelector(".ChatToolBar-DanmakuTail-tip").classList.add("ChatToolBar-DanmakuTail-tip-active")}function saveData_DanmakuTail(){var e={isTailEnabled:document.getElementById("DanmakuTail-checkbox").checked,tailContent:document.getElementById("DanmakuTail-input").value,type:document.querySelector('input[name="DanmakuTailType"]:checked').value};localStorage.setItem("ExSave_DanmakuTail",JSON.stringify(e))}function initPkg_DanmakuTail_Func(){document.getElementsByClassName("ChatToolBar-DanmakuTail")[0].addEventListener("click",function(){showExRightPanel("弹幕小尾巴")}),initPkg_DanmakuTail_HandleFunc("#DanmakuTail-checkbox","#DanmakuTail-input"),document.getElementById("DanmakuTail-checkbox").addEventListener("change",function(){saveData_DanmakuTail()}),document.querySelectorAll('input[name="DanmakuTailType"]').forEach(e=>{e.addEventListener("change",function(){saveData_DanmakuTail()})}),document.getElementById("DanmakuTail-input").addEventListener("input",function(){saveData_DanmakuTail()})}function initPkg_DanmakuTail_HandleFunc(e,t){let s=null,d=null;function o(o,n){let i=document.querySelector("textarea.ChatSend-txt")||document.querySelector("div.ChatSend-txt");const t=document.querySelector(".ChatSend-button");if(i&&t){c();const a="div"===i.tagName.toLowerCase(),r=()=>a?i.innerText:i.value,l=e=>{a?i.innerText=e:i.value=e};s=function(e){!e.isTrusted||"Enter"!==e.key||e.shiftKey||(e.preventDefault(),e.stopPropagation(),t.click())},d=function(e){var t=r();if(""!=t.trim()){let e=!1;(e="1"===n?!t.startsWith(o):!t.endsWith(o))&&("1"===n?l(o+t):l(t+o),i.dispatchEvent(new Event("input",{bubbles:!0})))}},i.addEventListener("keydown",s,!0),t.addEventListener("click",d,!0)}}function c(){var e=document.querySelector("textarea.ChatSend-txt")||document.querySelector("div.ChatSend-txt"),t=document.querySelector(".ChatSend-button");e&&s&&e.removeEventListener("keydown",s,!0),t&&d&&t.removeEventListener("click",d,!0),s=null,d=null}const n=document.querySelector(e),i=document.querySelector(t),a=document.querySelectorAll('input[name="DanmakuTailType"]');let r=document.querySelector('input[name="DanmakuTailType"]:checked').value;return n&&(n.addEventListener("change",function(){""===i.value.trim()?(n.checked=!1,showMessage("【弹幕小尾巴】请输入弹幕小尾巴内容","error")):(i.disabled=n.checked,a[0].disabled=n.checked,a[1].disabled=n.checked,document.querySelector(".ChatToolBar-DanmakuTail-tip").classList.remove("ChatToolBar-DanmakuTail-tip-active"),c(),n.checked&&i&&(document.querySelector(".ChatToolBar-DanmakuTail-tip").classList.add("ChatToolBar-DanmakuTail-tip-active"),o(i.value.trim(),r=document.querySelector('input[name="DanmakuTailType"]:checked').value)))}),n.checked)&&i&&o(i.value.trim(),r),{enable:o,disable:c}}function initPkg_DisableCloseJump_Timer(){setInterval(()=>{var e=document.querySelector(".ClosingRecommend .dy-ModalRadius-close-x");e&&e.click()},1e3)}let dyVideoBarrage_domhook_videoChange=null,dyVideoBarrage_hasRendered=!1;const dyVideoBarrage_domName="ex-barrageLine",dyVideoBarrage_switchDomName="ex-barrageLine-switch";function initPkg_DyVideoBarrageLine(){let n=setInterval(()=>{var e=document.getElementsByTagName("demand-video")[0].shadowRoot.getElementById("demandcontroller-bar").shadowRoot.querySelector("demand-video-controller-progress").shadowRoot.querySelector(".ProgressBar-Sign"),t=document.getElementsByTagName("demand-video-toolbar")[0].shadowRoot,o=document.getElementsByTagName("demand-video-toolbar")[0].shadowRoot;e&&t&&o&&(clearInterval(n),initPkg_DyVideoBarrageLine_Dom(),renderVideoBarrageLine(),e=o.querySelector("share-hover"),(dyVideoBarrage_domhook_videoChange=new MutationObserver(function(e){renderVideoBarrageLine()})).observe(e,{attributes:!0,childList:!0,subtree:!1}))},1e3)}function initPkg_DyVideoBarrageLine_Dom(){var e=document.createElement("style");e.innerHTML=`.no-hasLR #ex-barrageLine {
        display: none !important;
    }`,document.getElementsByTagName("demand-video")[0].shadowRoot.getElementById("demandcontroller-bar").shadowRoot.querySelector("demand-video-controller-progress").shadowRoot.append(e)}async function renderVideoBarrageLine(){if(!dyVideoBarrage_hasRendered){dyVideoBarrage_hasRendered=!0,setTimeout(()=>{dyVideoBarrage_hasRendered=!1},1e3),showMessage("弹幕高能进度条加载中，请耐心等待","info");var o=document.getElementsByTagName("demand-video")[0].shadowRoot.getElementById("demandcontroller-bar").shadowRoot.querySelector("demand-video-controller-progress").shadowRoot,n=o.querySelector(".ProgressBar"),o=o.querySelector("#"+dyVideoBarrage_domName),i=(o&&o.remove(),document.getElementsByTagName("demand-video-toolbar")[0].shadowRoot.querySelector("share-hover").getAttribute("hashid")),o=document.getElementsByTagName("demand-video")[0].shadowRoot.getElementById("demandcontroller-bar").shadowRoot.querySelector("#time-label").innerText.split("/");if(!(o.length<=0)){var a=timeText2Ms(o[1])/99,r=new Array(100).fill(0,0,100);let e=0;do{var l=await getVideoBarrageByTime(i,e);if(e=l.data.pre,l.data.list)for(let e=0;e<l.data.list.length;e++){var s=l.data.list[e];r[Math.floor(s.tl/a)]++}}while(0<=e);var d=1e3/r.length,c=Math.max(...r)/100,u=[];for(let e=0;e<r.length;e++){var m=r[e],p=e*d;u.push([p,m/c])}let t="";for(let e=0;e<u.length-1;e++){var[g,h]=u[e],[f,_]=u[e+1];t=t+"C "+(g+` ${80-(h+_)/2}, ${f} ${80-(h+_)/2}, ${f} ${80-_} `)}var o="M 0 100 L 0 80 "+(t+="L 1000 100 Z"),y=`
    ...
    `;var r=Math.floor(Date.now()/1e3);for(let e=0;e<a.data.list.length;e++){var l=a.data.list[e];if("1"==l.show_status&&"0"==l.videoLoop&&(o+=`<li class="DropPaneList FollowList ExFollowListItem" rid="${l.room_id}"><a><div class="DropPaneList-cover"><div class="LazyLoad is-visible DyImg "><img src="${String(l.avatar_small).replace("_big","_small")}" alt="${l.nickname}" class="DyImg-content is-normal "></div></div><div class="DropPaneList-info"><p><span class="DropPaneList-hot"><i></i>${l.online}</span><span class="DropPaneList-title">${l.room_name}</span></p><p><span class="DropPaneList-name">${l.nickname}</span><span class="DropPaneList-time">已播${formatSeconds(r-Number(l.show_time))}</span></p></div></a></li>`,t++),10<=t)break}e.innerHTML+=o;i=e.querySelector("#loadInCurrentPageCheckbox");i&&i.addEventListener("change",async e=>{e=e.target.checked;await GM_setValue("Ex_LoadInCurrentPage",e),showMessage(`【关注列表】已${e?"开启":"关闭"}当前页加载功能（${e?"当前页面直接加载关注的直播间":"使用新网页打开关注的直播间"}）`,"info")});let n=document.getElementsByClassName("ExFollowListItem");for(let o=0;o<n.length;o++){var s=new CClick(n[o]);s.longClick(()=>{createNewVideo(videoPlayerArr.length,n[o].getAttribute("rid"),"Douyu"),document.querySelector(".Follow .public-DropMenu").className="public-DropMenu"}),s.click(async e=>{e.preventDefault();var e=await GM_getValue("Ex_LoadInCurrentPage",!1),t="https://www.douyu.com/"+n[o].getAttribute("rid");e?window.location.href=t:openPage(t,!0)}),n[o].addEventListener("mousedown",e=>{1==e.button&&openPage("https://www.douyu.com/"+n[o].getAttribute("rid"),!1)})}}}function getFollowList(){return new Promise(t=>{fetch("https://www.douyu.com/wgapi/livenc/liveweb/follow/list?sort=1&cid1=0",{method:"GET",mode:"no-cors",credentials:"include",headers:{"Content-Type":"application/x-www-form-urlencoded"}}).then(e=>e.json()).then(e=>{t(e)})})}function initPkg_ImageDanmaku(){initPkg_ImageDanmaku_Dom(),initPkg_ImageDanmaku_Func()}function initPkg_ImageDanmaku_Dom(){var e=document.getElementsByClassName("ChatToolBar__right")[0],t=document.createElement("div");t.className="BarrageFilter",t.title="添加图片弹幕（仅安装插件的用户可见）",t.innerHTML=`
  ...
  `,e.insertBefore(t,e.firstChild)}function initPkg_ImageDanmaku_Func(){const i=document.getElementsByClassName("ChatSend-txt")[0];document.addEventListener("paste",async e=>{if(document.activeElement===i){var t,o=(e.clipboardData||e.originalEvent.clipboardData).items;for(t in o){var n=o[t];if("file"===n.kind&&n.type.startsWith("image/")){i.value+="[DouyuEx图片上传中]",addImageDanmaku(await getUploadImageUrl(n.getAsFile()));break}}}});let e=setInterval(()=>{void 0!==document.getElementById("js-barrage-list")&&(clearInterval(e),new DomHook("#js-barrage-list",!1,e=>{var t;e.length<=0||e[0].addedNodes.length<=0||(t=(e=e[0].addedNodes[0]).getElementsByClassName("Barrage-content"))&&0!==t.length&&(t=t[0].innerHTML).includes("[DouyuEx图片")&&(t=t.replace(/\[DouyuEx图片(.*?)\]/g,(e,t)=>getImageDanmakuHtml(t)),e.getElementsByClassName("Barrage-content")[0].innerHTML=t)}))},1e3),t=setInterval(()=>{void 0!==document.getElementsByClassName("danmu-fbb2a3")[0]&&(clearInterval(t),new DomHook(".danmu-fbb2a3",!1,e=>{var t;e.length<=0||e[0].addedNodes.length<=0||(e=e[0].addedNodes[0])&&e.innerHTML&&(t=e.innerHTML).includes("[DouyuEx图片")&&(t=t.replace(/\[DouyuEx图片(.*?)\]/g,(e,t)=>getImageDanmakuHtml(t)),e.innerHTML=t)}))},1e3);document.getElementById("ex-upload-image-svg").addEventListener("click",()=>{document.getElementById("ex-upload-image-input").click()}),document.getElementById("ex-upload-image-input").addEventListener("change",async e=>{i.value+="[DouyuEx图片上传中]",addImageDanmaku(await getUploadImageUrl(e.target.files[0]).catch(e=>console.log(e)))})}function getImageDanmakuHtml(e){var t;return isValidImageFile(e)?(t=decompressImageUrl((e=e.split("."))[0]),e=`<a href="${(t=DOMPurify.sanitize(`https://img.douyucdn.cn/data/yuba/weibo/${t.slice(0,4)+"/"+t.slice(4,6)+"/"+t.slice(6,8)+"/"+t}.200x0.`+e[1])).replace("200x0.","")}" target="_blank"><img class="ex-image-danmaku" src="${t}" alt=""></a>`,DOMPurify.sanitize(e)):""}function addImageDanmaku(e){var t=document.getElementsByClassName("ChatSend-txt")[0],e=e.split(".");t.value=t.value.replace("[DouyuEx图片上传中]",`[DouyuEx图片${compressImageUrl(e[0])}.${e[1]}]`)}function compressImageUrl(e){return BigInt(e).toString(36)}function decompressImageUrl(t){let o=0n,n=1n;for(let e=t.length-1;0<=e;e--){var i=t[e].toUpperCase(),a="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(i);if(-1===a)throw new Error("Invalid base36 character: "+i);o+=BigInt(a)*n,n*=36n}return o.toString()}function getUploadPreRequest(){return new Promise(t=>{GM_xmlhttpRequest({method:"GET",url:"https://yuba.douyu.com/wbapi/web/image/preRequest?source=&timestamp="+(new Date).getTime(),responseType:"json",headers:{"dy-client":"pc","dy-token":dyToken},onload:function(e){t(e.response)}})})}function dataURLtoBlob(e){for(var e=e.split(","),t=e[0].match(/:(.*?);/)[1],o=atob(e[1]),n=o.length,i=new Uint8Array(n);n--;)i[n]=o.charCodeAt(n);return new Blob([i],{type:t})}function getUploadImageUrl(r){return new Promise(async(t,o)=>{var e=(await getUploadPreRequest()).data;if(e){var n,i=new FormData;for(n in e)i.append(n,e[n]);i.append("file",r);var a=new XMLHttpRequest;a.open("POST","https://img.douyucdn.cn/upload",!0),a.onload=function(){if(200<=this.status&&this.status<400)try{var e=JSON.parse(this.response).uri.split("/").pop().split("?")[0];t(e)}catch(e){o(e)}else o("图片上传失败")},a.send(i)}})}function getImageDanmakuFromImgSrc(e){e=e.split("/").pop().split(".");return`[DouyuEx图片${compressImageUrl(e[0])}.${e[2]}]`}function initPkg_LastLiveTime(){initPkg_LastLiveTime_Dom()}function initPkg_LastLiveTime_Dom(){const i="ex-LastLiveTime-overlay";var t=document.body.innerHTML.match(/show_time\\":(\d+)/);if(t){const a=1e3*parseInt(t[1],10),n=()=>{var e=dateFormat("yyyy-MM-dd hh:mm:ss",new Date(a)),t=timeago(a),o=document.createElement("div"),n=(o.id=i,o.style.position="absolute",o.style.top="0",o.style.left="0",o.style.width="100%",o.style.height="100%",o.style.display="flex",o.style.justifyContent="center",o.style.alignItems="center",o.style.zIndex="1",o.style.pointerEvents="none",document.createElement("div"));return n.innerHTML=`
    ...
    `,document.getElementsByClassName("livetool")[0]);t.insertBefore(e,t.childNodes[0])}function LiveTool_CountBp_insertFunc(){document.getElementById("count_bp__title").addEventListener("click",()=>{var e=document.getElementsByClassName("count_bp__panel")[0];e.style.display="block"===e.style.display?"none":"block"}),document.getElementById("count_bp__add_input").addEventListener("change",()=>{countBpAdd=Number(document.getElementById("count_bp__add_input").value)||0,updateCountBpDisplay(),saveData_CountBpSettings()}),document.getElementById("count_bp__original_input").addEventListener("change",()=>{countBpOriginal=Number(document.getElementById("count_bp__original_input").value)||0,countBpCurrent=countBpOriginal-countBpReduce,updateCountBpDisplay(),saveData_CountBpSettings()}),document.getElementById("count_bp__add_btn").addEventListener("click",()=>{handleCountBpAdd()}),document.getElementById("count_bp__reset_btn").addEventListener("click",()=>{handleCountBpReset()}),document.getElementById("count_bp__summary_btn").addEventListener("click",()=>{sendCountBpSummary()})}function updateCountBpDisplay(){var e=document.getElementById("count_bp__status"),t=`${countBpOriginal} - ${countBpReduce} = `+countBpCurrent;document.getElementById("count_bp__add_input").value=countBpAdd,document.getElementById("count_bp__original_input").value=countBpOriginal,countBpCurrent<=0?e.innerHTML=`当前已扣${countBpReduce}命，已加${countBpAdd}命，已团灭！`:e.innerHTML=`当前已扣${countBpReduce}命，已加${countBpAdd}命，剩余${t}命`}function handleCountBpAdd(){if(!isCountBpCD){countBpReduce++,countBpCurrent=countBpOriginal-countBpReduce,updateCountBpDisplay(),saveData_CountBpSettings();let e;sendBarrage(e=countBpCurrent<=0?`当前已扣${countBpReduce}命，已团灭！`:`当前已扣${countBpReduce}命！`),0<countBpCd&&(isCountBpCD=!0,setTimeout(()=>{isCountBpCD=!1},1e3*countBpCd))}}function handleCountBpReset(){countBpReduce=0,countBpAdd=0,countBpOriginal=0,countBpCurrent=0,updateCountBpDisplay(),saveData_CountBpSettings()}function sendCountBpSummary(){var e=`${countBpOriginal} - ${countBpReduce} = `+countBpCurrent,t=`${countBpOriginal} - ${countBpReduce} + ${countBpAdd} = `+(countBpCurrent+countBpAdd);let o;sendBarrage(o=countBpCurrent<=0?`当前已扣${countBpReduce}命，已加${countBpAdd}命，已团灭！（${e}）`:`当前已扣${countBpReduce}命，已加${countBpAdd}命，剩余${t}命`)}function saveData_CountBpSettings(){localStorage.setItem("ExSave_CountBpReduce",countBpReduce),localStorage.setItem("ExSave_CountBpAdd",countBpAdd),localStorage.setItem("ExSave_CountBpOriginal",countBpOriginal),localStorage.setItem("ExSave_CountBpCurrent",countBpCurrent)}function initPkg_CountBp_Set(){ret=localStorage.getItem("ExSave_CountBpReduce"),countBpReduce=null!==ret?Number(ret):0,null!==(ret=localStorage.getItem("ExSave_CountBpAdd"))?(countBpAdd=Number(ret),document.getElementById("count_bp__add_input").value=ret):countBpAdd=0,null!==(ret=localStorage.getItem("ExSave_CountBpOriginal"))?(countBpOriginal=Number(ret),document.getElementById("count_bp__original_input").value=ret):countBpOriginal=0,ret=localStorage.getItem("ExSave_CountBpCurrent"),countBpCurrent=null!==ret?Number(ret):0,updateCountBpDisplay()}window.countBpInitialized||(window.countBpInitialized=!0,setTimeout(initPkg_LiveTool_CountBp,1e3));let isEnterOn=!1,enterWordList=[];function initPkg_LiveTool_Enter(){LiveTool_Enter_insertDom(),LiveTool_Enter_insertFunc(),initPkg_Enter_Set()}function LiveTool_Enter_insertDom(){var e=document.createElement("div"),t=(e.className="livetool__cell",e.innerHTML=`
        <div class='livetool__cell_title'>
...
`),showMessage("请按F12到控制台(console)查看礼物id","success")}),document.getElementById("gift__switch").addEventListener("click",()=>{var e=document.getElementById("gift__switch").checked;isGiftOn=1==e,saveData_isGift()}),document.getElementById("gift__title").addEventListener("click",()=>{var e=document.getElementsByClassName("gift__panel")[0];"block"!=e.style.display?((e.style.display="block")==document.getElementsByClassName("mute__panel")[0].style.display&&(document.getElementsByClassName("mute__panel")[0].style.display="none"),"block"==document.getElementsByClassName("enter__panel")[0].style.display&&(document.getElementsByClassName("enter__panel")[0].style.display="none"),"block"==document.getElementsByClassName("reply__panel")[0].style.display&&(document.getElementsByClassName("reply__panel")[0].style.display="none"),"block"==document.getElementsByClassName("vote__panel")[0].style.display&&(document.getElementsByClassName("vote__panel")[0].style.display="none")):e.style.display="none"}),document.getElementById("gift__select").onclick=function(){var e,t;0!=this.options.length&&(e=this.options[this.selectedIndex].text,t=giftWordList[e].reply,document.getElementById("gift__giftId").value=e,document.getElementById("gift__reply").value=t)},document.getElementById("gift__add").addEventListener("click",()=>{var e=document.getElementById("gift__select"),t=document.getElementById("gift__giftId").value,o=document.getElementById("gift__reply").value;""!=t&&(giftWordList[t]={reply:o},e.options.add(new Option(t,"")),saveData_Gift())}),document.getElementById("gift__del").addEventListener("click",()=>{var e=document.getElementById("gift__select"),t=e.options[e.selectedIndex].text;delete giftWordList[t],e.options.remove(e.selectedIndex),saveData_Gift()}),document.getElementById("gift__export").addEventListener("click",()=>{GM_setClipboard(JSON.stringify(giftWordList)),showMessage("【自动谢礼物】导出完毕，已复制到剪贴板","success")}),document.getElementById("gift__import").addEventListener("click",()=>{PostbirdAlertBox.prompt({title:"请输入json文本（会覆盖原来的设置）",okBtn:"确定",onConfirm:function(e){var t=document.getElementById("gift__select"),e=JSON.parse(e||"{}")||{};if("object"==typeof e){for(var o in giftWordList={...e},t.options.length=0,giftWordList)giftWordList.hasOwnProperty(o)&&t.options.add(new Option(o,""));saveData_Gift()}showMessage("【自动谢礼物】导入完毕","success")},onCancel:function(e){}})}),document.getElementById("gift__template").addEventListener("click",()=>{setAllGiftTemplate()})}function saveData_Gift(){var e=giftWordList;localStorage.setItem("ExSave_Gift",JSON.stringify(e))}function saveData_isGift(){let e=[];var t=localStorage.getItem("ExSave_isGift"),t=(e=null!=t&&"rooms"in(t=JSON.parse(t))==1?t.rooms:e).indexOf(rid),t=(1==isGiftOn?-1==t&&e.push(rid):e.splice(t,1),{rooms:e});localStorage.setItem("ExSave_isGift",JSON.stringify(t))}function initPkg_Gift_Set(){var t=localStorage.getItem("ExSave_Gift");if(null!=t){var e,o=JSON.parse(t),n=(giftWordList=o,document.getElementById("gift__select"));for(e in o)o.hasOwnProperty(e)&&n.options.add(new Option(e,""))}if(null!=(t=localStorage.getItem("ExSave_isGift"))){t=JSON.parse(t);let e=[];"rooms"in t==1&&(e=t.rooms),isGiftOn=-1!=e.indexOf(rid)}else isGiftOn=!1;document.getElementById("gift__switch").checked=isGiftOn}function initPkg_LiveTool_Gift_Handle(e){var t,o,n,i;0!=isGiftOn&&("dgb"===(t=getType(e))?getStrMiddle(e,"uid@=","/")!=my_uid&&(o=getStrMiddle(e,"nn@=","/"),i=getStrMiddle(e,"gfid@=","/"),n=getStrMiddle(e,"gfcnt@=","/"),i in giftWordList)&&(i=giftWordList[i].reply,i=String(i).replace(/<id>/g,o),sendBarrage(i=String(i).replace(/<cnt>/g,n))):"dfobc"!==t&&"dfrbc"!==t||getStrMiddle(e,"uid@=","/")!=my_uid&&(o=getStrMiddle(e,"nick@=","/"),(n="dfobc"===t?"开通钻粉":"续费钻粉")in giftWordList)&&(i=giftWordList[n].reply,i=String(i).replace(/<id>/g,o),sendBarrage(i=String(i).replace(/<cnt>/g,"1"))))}async function setAllGiftTemplate(){var t={},o=await getRoomGiftTemplate();for(let e=0;e<o.data.gift.length;e++){var n=o.data.gift[e];t[n.id]={reply:`感谢<id>赠送的${n.name}x<cnt>`}}let e=await getBagGiftTemplate();var i={};e=(e=e.substring(0,e.length-2)).replace("DYConfigCallback(","");for(const r in(e=JSON.parse(e||"{}")||{}).data)i[r]={reply:`感谢<id>赠送的${e.data[r].name}x<cnt>`};var a={"开通钻粉":{reply:"感谢<id>开通钻粉"},"续费钻粉":{reply:"感谢<id>续费钻粉"}},a={...t,...i,...a};GM_setClipboard(JSON.stringify(a)),showMessage("【自动谢礼物】礼物模板生成完毕，已复制到剪贴板，可直接导入","success")}function getRoomGiftTemplate(){return new Promise(t=>{GM_xmlhttpRequest({method:"GET",url:"http://open.douyucdn.cn/api/RoomApi/room/"+rid,responseType:"json",onload:function(e){e=e.response;t(e)}})})}function getBagGiftTemplate(){return new Promise(t=>{GM_xmlhttpRequest({method:"GET",url:"http://webconf.douyucdn.cn/resource/common/prop_gift_list/prop_gift_config.json",responseType:"text",onload:function(e){e=e.response;t(e)}})})}let timer_closing,closingNum=0;function initPkg_LiveTool_LiveNotice(){}function initPkg_LiveTool_LiveNotice_Handle(t){if("rss"==getType(t)){let e=getStrMiddle(t,"rid@=","/");var o=getStrMiddle(t,"ss@=","/"),t=getStrMiddle(t,"ivl@=","/");"1"==o&&"0"==t&&showMessageWindow("开播提醒","直播间："+e+"开播了，点我签到",()=>{signRoom(e)})}}function getRoomAvatar(){fetch("https://www.douyu.com/betard/"+rid,{method:"GET",mode:"no-cors",credentials:"include"}).then(e=>e.json()).then(e=>{roomAvatar=e.room.avatar.middle}).catch(e=>{console.log("请求失败!",e)})}function initPkg_LiveTool(){initPkg_LiveTool_Dom(),initPkg_LiveTool_Module(),initPkg_LiveTool_Func(),initPkg_LiveTool_HandleFunc()}function initPkg_LiveTool_Dom(){LiveTool_insertModal(),LiveTool_insertIcon()}function initPkg_LiveTool_Module(){initPkg_LiveTool_Vote(),initPkg_LiveTool_Enter(),initPkg_LiveTool_Mute(),initPkg_LiveTool_Gift(),initPkg_LiveTool_Reply(),initPkg_LiveTool_RedPacket_Bp(),initPkg_LiveTool_CountBp(),initPkg_LiveTool_Treasure(),initPkg_LiveTool_BarrageSpeed(),initPkg_LiveTool_RankList(),initPkg_LiveTool_BarrageSendCheck()}function LiveTool_insertModal(){var e=document.createElement("div"),t=(e.className="livetool",document.getElementsByClassName("layout-Player-chat")[0]);t.insertBefore(e,t.childNodes[0])}function LiveTool_insertIcon(){var e=document.createElement("div"),t=(e.className="livetool-icon",e.innerHTML='<a class="ex-panel__icon" title="直播间工具"><svg t="1590294900594" style="display:block;" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="20028" width="36" height="36"><path d="M352.2 245.3c-5.1 0-10.2-2-14.1-5.9L196.6 98c-7.8-7.8-7.8-20.5 0-28.3s20.5-7.8 28.3 0l141.4 141.4c7.8 7.8 7.8 20.5 0 28.3-3.9 3.9-9 5.9-14.1 5.9zM477.1 245.3c-5.1 0-10.2-2-14.1-5.9-7.8-7.8-7.8-20.5 0-28.3L604.3 69.7c7.8-7.8 20.5-7.8 28.3 0 7.8 7.8 7.8 20.5 0 28.3L491.2 239.4c-3.9 3.9-9 5.9-14.1 5.9z" fill="#0C2B4A" p-id="20029"></path><path d="M703.9 194.8H124.2c-33 0-60 27-60 60v453c0 33 27 60 60 60h418c1.7-122.5 99.6-221.8 221.7-225.5V254.8c0-33-27-60-60-60zM533.4 522.9L356.3 625.2c-24 13.9-54-3.5-54-31.2V389.5c0-27.7 30-45 54-31.2l177.1 102.2c24 13.9 24 48.6 0 62.4zM815.2 776.4c0 21.9-17.8 39.7-39.7 39.7-21.9 0-39.7-17.8-39.7-39.7 0-21.9 17.8-39.7 39.7-39.7 21.9 0 39.7 17.8 39.7 39.7z" fill="#0C2B4A" p-id="20030"></path><path d="M775.5 591C673.6 591 591 673.6 591 775.5S673.6 960 775.5 960 960 877.4 960 775.5 877.4 591 775.5 591zM879 819l-15.6 27c-2.1 3.6-6.8 4.9-10.4 2.8l-15.5-8.9c-2.7-1.6-6.1-1.3-8.5 0.6-7.5 5.9-15.9 10.6-25.1 13.8-3 1.1-5.1 4-5.1 7.2v18.7c0 4.2-3.4 7.6-7.6 7.6H760c-4.2 0-7.6-3.4-7.6-7.6v-18.5c0-3.3-2.1-6.2-5.1-7.2-9.3-3.2-17.9-7.8-25.5-13.7-2.4-1.9-5.8-2.2-8.5-0.6l-15.2 8.8c-3.6 2.1-8.3 0.9-10.4-2.8l-15.6-27c-2.1-3.6-0.8-8.3 2.8-10.4l12.2-7.1c3-1.7 4.5-5.2 3.7-8.5-1.7-6.8-2.6-13.8-2.6-21.1 0-4.1 0.3-8.2 0.9-12.2 0.4-3.1-1-6.1-3.7-7.7l-10.5-6.1c-3.6-2.1-4.9-6.8-2.8-10.4l15.6-27c2.1-3.6 6.8-4.9 10.4-2.8l7.8 4.5c2.9 1.7 6.6 1.3 9-1.1 9.1-8.7 20-15.5 32.2-19.7 3.1-1 5.1-4 5.1-7.2v-7.9c0-4.2 3.4-7.6 7.6-7.6H791c4.2 0 7.6 3.4 7.6 7.6v8.1c0 3.2 2 6.1 5.1 7.2 12.1 4.2 22.9 10.9 31.9 19.6 2.4 2.4 6.1 2.8 9.1 1.1l8.2-4.7c3.6-2.1 8.3-0.8 10.4 2.8l15.6 27c2.1 3.6 0.9 8.3-2.8 10.4l-11 6.3c-2.7 1.6-4.1 4.6-3.7 7.7 0.6 3.9 0.8 8 0.8 12.1 0 7.2-0.9 14.1-2.5 20.8-0.8 3.3 0.7 6.7 3.6 8.3l12.8 7.4c3.7 2.1 5 6.8 2.9 10.4z" fill="#0C2B4A" p-id="20031"></path></svg><i id="LiveTool__tip" class="ex-panel__tip"></i></a>',document.getElementsByClassName("ex-panel__wrap")[0]);t.insertBefore(e,t.childNodes[0])}function initPkg_LiveTool_Func(){document.getElementsByClassName("livetool-icon")[0].addEventListener("click",function(){showExRightPanel("直播间工具")})}function initPkg_LiveTool_HandleFunc(){new Ex_WebSocket_UnLogin(rid,e=>{initPkg_LiveTool_LiveNotice_Handle(e),initPkg_LiveTool_Mute_Handle(e),initPkg_LiveTool_Reply_Handle(e),initPkg_LiveTool_RedPacket_Bp_Handle(e),initPkg_LiveTool_Gift_Handle(e),initPkg_LiveTool_Treasure_Handle(e),initPkg_LiveTool_Enter_Handle(e),initPkg_LiveTool_Vote_Handle(e),initPkg_LiveTool_BarrageSpeed_Handle(e),initPkg_LiveTool_RankList_Handle(e),initPkg_LiveTool_BarrageSendCheck_Handle(e)})}function getType(e){return getStrMiddle(e,"type@=","/")}function selectOptionByValue(e,t){var o=document.getElementById(e);for(let e=0;e<o.options.length;e++)if(o.options[e].value==t){o.options[e].selected=!0;break}}let isMuteOn=!1,muteWordList={},muteIdList={},muteIdListShow=[];function initPkg_LiveTool_Mute(){LiveTool_Mute_insertDom(),LiveTool_Mute_insertFunc(),initPkg_Mute_Set()}function LiveTool_Mute_insertDom(){var e=document.createElement("div"),t=(e.className="livetool__cell",e.innerHTML=`
    ...
    `,document.getElementsByClassName("livetool")[0]);t.insertBefore(e,t.childNodes[0])}function LiveTool_RedPacket_insertFunc(){document.getElementById("redpacket__switch").addEventListener("click",()=>{isRedPacketOn=document.getElementById("redpacket__switch").checked,saveData_isRedPacket()}),document.getElementById("redpacket__title").addEventListener("click",()=>{var e=document.getElementsByClassName("redpacket__panel")[0];e.style.display="block"===e.style.display?"none":"block"}),document.getElementById("redpacket__delay").addEventListener("change",()=>{redPacketDelay=Number(document.getElementById("redpacket__delay").value)||0,saveData_RedPacketSettings()}),document.getElementById("redpacket__cd").addEventListener("change",()=>{redPacketCd=Number(document.getElementById("redpacket__cd").value)||0,saveData_RedPacketSettings()})}function saveData_RedPacketSettings(){localStorage.setItem("ExSave_RedPacketDelay",redPacketDelay),localStorage.setItem("ExSave_RedPacketCd",redPacketCd)}function saveData_isRedPacket(){let e=[];var t=localStorage.getItem("ExSave_isRedPacket"),t=(e=t&&"rooms"in(t=JSON.parse(t))?t.rooms:e).indexOf(rid),t=(isRedPacketOn?-1===t&&e.push(rid):-1!==t&&e.splice(t,1),{rooms:e});localStorage.setItem("ExSave_isRedPacket",JSON.stringify(t))}function initPkg_RedPacket_Set(){var e,t=localStorage.getItem("ExSave_isRedPacket");t?(e=JSON.parse(t).rooms||[],isRedPacketOn=e.includes(rid),document.getElementById("redpacket__switch").checked=isRedPacketOn):(isRedPacketOn=!1,document.getElementById("redpacket__switch").checked=!1),(t=localStorage.getItem("ExSave_RedPacketDelay"))?(redPacketDelay=Number(t),document.getElementById("redpacket__delay").value=t):redPacketDelay=0,(t=localStorage.getItem("ExSave_RedPacketCd"))?(redPacketCd=Number(t),document.getElementById("redpacket__cd").value=t):redPacketCd=0}function initPkg_LiveTool_RedPacket_Bp_Handle(t){if(isRedPacketOn&&!isRedPacketCD&&!isWaitingReply&&"chatmsg"===getType(t)){var o=getStrMiddle(t,"uid@=","/");if(o!==my_uid){o=getStrMiddle(t,"txt@=","/");if(o.startsWith("#红包")){t=o.trim().split(/\s+/);let e="#抢 "+(1<t.length?t[1]:"老板大气");0<redPacketDelay?(isWaitingReply=!0,setTimeout(()=>{sendBarrage(e),isWaitingReply=!1,0<redPacketCd&&(isRedPacketCD=!0,setTimeout(()=>{isRedPacketCD=!1},1e3*redPacketCd))},1e3*redPacketDelay)):(sendBarrage(e),0<redPacketCd&&(isRedPacketCD=!0,setTimeout(()=>{isRedPacketCD=!1},1e3*redPacketCd)))}}}}let isReplyOn=!1,replyWordList={},isReplyCD=!1,replyCd=0;function initPkg_LiveTool_Reply(){LiveTool_Reply_insertDom(),LiveTool_Reply_insertFunc(),initPkg_Reply_Set()}function LiveTool_Reply_insertDom(){var e=document.createElement("div"),t=(e.className="livetool__cell",e.innerHTML=`
        <div class='livetool__cell_title'>
    ...
    `,document.getElementsByClassName("layout-Player-chat")[0]);t.insertBefore(e,t.childNodes[0])}function initPkg_Lottery_Func(){let t=document.getElementById("lottery-notice");document.getElementsByClassName("ex-lottery")[0].addEventListener("click",()=>{showExRightPanel("全站抽奖信息");var e=document.getElementsByClassName("lottery__wrap")[0];e&&(e.innerHTML=lotteryHTML)}),document.getElementById("lottery-refresh").addEventListener("click",debounce(()=>{initPkg_Lottery_Timer()},3e3)),t.addEventListener("click",()=>{var e=t.checked;isLotteryNotice=1==e,saveData_Lottery()})}async function initPkg_Lottery_Timer(){let t="";var o=await getExLotteryList();if(o.data.list){for(let e=0;e<o.data.list.length;e++){var n,i,a,r,l,s,d=o.data.list[e];0===d.status&&(a="command_content"in(i=(n=await getExLotteryInfo(d.room_id)).data.join_condition)?"发送弹幕":`赠送 ${i.gift_name}（${i.gift_price}）x`+i.gift_num,r=-1==(r=getTimeDiff(1e3*(Number(n.data.start_at)+Number(n.data.join_condition.expire_time)),(new Date).getTime()))?"已结束":"距结束："+r,(l=-1!==myFansBadgeList.indexOf(String(d.room_id))||i.lottery_range<=1)&&isLotteryNotice&&((s=n.data.prize_name+"|"+n.data.start_at)in lotteryHasNoticed||(lotteryHasNoticed[s]=1,showMessage(`<a style="font-size:14px;border:none;" target="_blank" href="https://www.douyu.com/${d.room_id}">【${n.data.prize_name}x${n.data.prize_num}】${a}</a>`,"special",{timeout:100}))),t+=`
    ...
    * {
    ...
    `),current_barrage_status=1,document.getElementById("refresh-barrage").classList.add("ex-active"),document.getElementById("refresh-barrage__text").style.color="#fff",document.getElementById("refresh-barrage__text").innerText="前缀";var e=document.getElementById("refresh-barrage__svg");e&&(e=e.getElementsByTagName("path")[0])&&e.setAttribute("fill","#ffffff")}function cancelRefreshBarrage(){StyleHook_remove("Ex_Style_RefreshBarrage"),current_barrage_status=0,document.getElementById("refresh-barrage").classList.remove("ex-active"),document.getElementById("refresh-barrage__text").style.color="",document.getElementById("refresh-barrage__text").innerText="前缀";var e=document.getElementById("refresh-barrage__svg");e&&(e=e.getElementsByTagName("path")[0])&&e.setAttribute("fill","#AFAFAF")}function initPkg_Refresh_BarrageFrame(){initPkg_Refresh_BarrageFrame_Dom(),initPkg_Refresh_BarrageFrame_Func(),initPkg_Refresh_BarrageFrame_Set()}function initPkg_Refresh_BarrageFrame_Dom(){Refresh_BarrageFrame_insertIcon()}function Refresh_BarrageFrame_insertIcon(){var e=document.createElement("a"),t=(e.className="refresh-barrage",e.id="refresh-barrage-frame",e.innerHTML='<svg t="1588051109604" id="refresh-barrage-frame__svg" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3095" width="16" height="16"><path d="M512 128 192 448h192v448h256V448h192L512 128z" fill="#AFAFAF" p-id="3096"></path></svg><i class="Barrage-toolbarIcon"></i><span id="refresh-barrage-frame__text" class="Barrage-toolbarText">拉高</span>',document.getElementsByClassName("Barrage-toolbar")[0]);t.insertBefore(e,t.childNodes[0])}function initPkg_Refresh_BarrageFrame_Func(){document.getElementById("refresh-barrage-frame").addEventListener("click",function(){let t=document.getElementsByClassName("layout-Player-rank")[0],o=document.getElementById("js-room-activity"),n=document.getElementsByClassName("Barrage")[0];var e;"none"==t.style.display?(t.style.display="block",o.style.display="block",n.className="Barrage",document.getElementById("refresh-barrage-frame__text").innerText="拉高",document.getElementById("refresh-barrage-frame").classList.remove("ex-active"),document.getElementById("refresh-barrage-frame__text").style.color="",(e=document.getElementById("refresh-barrage-frame__svg"))&&(e=e.getElementsByTagName("path")[0])&&e.setAttribute("fill","#AFAFAF"),saveData_Refresh()):PostbirdAlertBox.confirm({title:"提示",content:"是否拉高弹幕框，隐藏日榜周榜",okBtn:"确定",cancelBtn:"取消",onConfirm:function(){t.style.display="none",o.style.display="none",n.className="Barrage top-0-important",document.getElementById("refresh-barrage-frame__text").innerText="拉高",document.getElementById("refresh-barrage-frame").classList.add("ex-active"),document.getElementById("refresh-barrage-frame__text").style.color="#fff";var e=document.getElementById("refresh-barrage-frame__svg");e&&(e=e.getElementsByTagName("path")[0])&&e.setAttribute("fill","#ffffff"),saveData_Refresh()},onCancel:function(){}})})}function refresh_BarrageFrame_getStatus(){return"none"==document.getElementsByClassName("layout-Player-rank")[0].style.display}function initPkg_Refresh_BarrageFrame_Set(){var e,t=localStorage.getItem("ExSave_Refresh");null!=t&&("barrageFrame"in(t=JSON.parse(t))==0&&(t.barrageFrame={status:!1}),1==t.barrageFrame.status)&&(t=document.getElementsByClassName("layout-Player-rank")[0],e=document.getElementById("js-room-activity"),t.style.display="none",e.style.display="none",document.getElementById("refresh-barrage-frame__text").innerText="拉高",document.getElementById("refresh-barrage-frame").classList.add("ex-active"),document.getElementById("refresh-barrage-frame__text").style.color="#fff",t=document.getElementById("refresh-barrage-frame__svg"))&&(e=t.getElementsByTagName("path")[0])&&e.setAttribute("fill","#ffffff")}let video_num=0;function initPkg_Refresh_Video(){let e=setInterval(()=>{getValidDom([".right-e7ea5d",".right-17e251"])&&(clearInterval(e),initPkg_Refresh_Video_Dom(),initPkg_Refresh_Video_Func(),initPkg_Refresh_Video_Set()),100<=++video_num&&clearInterval(e)},1500)}function initPkg_Refresh_Video_Dom(){Refresh_Video_insertIcon()}function Refresh_Video_insertIcon(){let e=document.createElement("li"),t=(e.id="refresh-video",e.innerText="简洁模式",document.getElementsByClassName("menu-da2a9e")[0]);t.insertBefore(e,t.childNodes[t.childNodes.length-1]),!document.getElementById("refresh-video3")&&((e=document.createElement("div")).id="refresh-video3",e.title="开启简洁模式",e.innerText="简",e.style="position:absolute;right:18px;bottom:58px;width:32px;height:32px;border-radius:8px;display:flex;align-items:center;justify-content:center;background:rgba(0,0,0,.55);color:#fff;z-index:9999;cursor:pointer;user-select:none;font-size:18px;line-height:32px;opacity:0;transform:scale(.9);transition:opacity .15s ease,transform .15s ease,background-color .15s ease;pointer-events:none;",t=document.getElementById("js-player-dialog"))&&t.insertBefore(e,t.childNodes[0])}function initPkg_Refresh_Video_Func(){function i(){let e=!1;var t=!!(document.fullscreenElement||document.webkitFullscreenElement||document.mozFullScreenElement||document.msFullscreenElement);let o=!1;(document.querySelector(".wfs-2a8e83.removed-9d4c42")||document.querySelector(".toggle__P8TKM"))&&(e=!0),document.querySelector(".shrink__Sd0uK")&&(o=!0);var n=document.getElementById("js-player-toolbar"),i=(n.style=e?"z-index:20":"z-index:30",document.getElementsByClassName("case__f4yex")[0]),i=(i&&(i.style=(t||e&&o)&&refresh_Video_getStatus()?"bottom: -84px;":"bottom: 0;"),!!document.getElementsByClassName("live-next-body")[0]);i&&(n.parentElement.style="z-index:20")}new DomHook(".right-e7ea5d",!0,()=>{i()}),new DomHook(".right-17e251",!0,()=>{i()}),new DomHook(".video__VfhVg",!0,e=>{for(const t of e)t.target.className.includes("toggle__P8TKM")&&i()});var e=getValidDom([".layout-Player-video",".stream__T55I3"]),t=document.getElementsByClassName("room-Player-Box")[0];let o=document.getElementById("refresh-video3"),n=0;function a(){o&&(o.style.opacity="0",o.style.transform="scale(.9)",o.style.pointerEvents="none",clearTimeout(n))}function r(){o&&(o.style.opacity="1",o.style.transform="scale(1)",o.style.pointerEvents="auto",clearTimeout(n),n=setTimeout(()=>{a()},2e3))}function l(){var e=document.getElementsByClassName("PlayerToolbar-ContentRow")[0],t=getValidDom([".layout-Player-video",".stream__T55I3"]),o=document.getElementById("refresh-video"),n=document.getElementById("refresh-video3");e&&t&&o&&(("hidden"==e.style.visibility?(e.style.visibility="visible",t.style="",n&&(n.style.opacity="0",n.style.transform="scale(.9)",n.style.pointerEvents="none",n.title="开启简洁模式"),o.innerText="简洁模式",refresh_Video_removeStyle):(e.style.visibility="hidden",t.style="bottom:0;z-index:25",o.innerText="✓ 简洁模式",n&&(n.title="关闭简洁模式"),refresh_Video_setStyle))(),i(),saveData_Refresh(),resizeWindow())}e&&o&&(e.addEventListener("mouseenter",()=>{r()}),e.addEventListener("mouseleave",()=>{a()})),t&&o&&t.addEventListener("mousemove",()=>{r()}),o&&(o.addEventListener("mouseenter",()=>{o.style.opacity="1",o.style.transform="scale(1.08)",o.style.pointerEvents="auto",o.style.backgroundColor="rgba(0,0,0,.7)",clearTimeout(n)}),o.addEventListener("mouseleave",()=>{o.style.transform="scale(1)",o.style.backgroundColor="rgba(0,0,0,.55)"})),document.getElementById("refresh-video").addEventListener("click",e=>{l()}),o&&o.addEventListener("click",e=>{e.stopPropagation(),l()})}function refresh_Video_getStatus(){return"hidden"==document.getElementsByClassName("PlayerToolbar-ContentRow")[0].style.visibility}function initPkg_Refresh_Video_Set(){var e,t,o,n,i=localStorage.getItem("ExSave_Refresh");null!=i&&("video"in(i=JSON.parse(i))==0&&(i.video={status:!1}),1==i.video.status)&&(i=document.getElementsByClassName("PlayerToolbar-ContentRow")[0],e=getValidDom([".layout-Player-video",".stream__T55I3"]),t=document.getElementById("refresh-video"),o=document.getElementById("refresh-video3"),n=document.getElementById("js-player-toolbar"),i.style.visibility="hidden",e.style="bottom:0;z-index:25",n.style="z-index:30",null!=(i=localStorage.getItem("ExSave_FullScreen"))&&JSON.parse(i).isFullScreen&&(n.style="z-index:20"),document.getElementsByClassName("live-next-body")[0]&&(n.parentElement.style="z-index:20"),o&&(o.style.opacity="0",o.style.transform="scale(.9)",o.style.pointerEvents="none",o.title="关闭简洁模式"),t.innerText="✓ 简洁模式",refresh_Video_setStyle(),resizeWindow())}function refresh_Video_setStyle(){StyleHook_set("Ex_Style_VideoRefresh",`
    ...
    `)}function refresh_Video_removeStyle(){StyleHook_remove("Ex_Style_VideoRefresh")}function initPkg_RemoveAD(){let e=setInterval(()=>{null!=getValidDom([".PlayerToolbar-ContentCell .PlayerToolbar-Wealth","#js-backpack-enter"])&&(clearInterval(e),optimizePageStyle(),initPkg_RemoveMsgNotice())},1e3)}function removeAD(){StyleHook_set("Ex_Style_RemoveAD",`
    ...
    `)}function optimizePageStyle(){document.getElementById("js-barrage-list").parentNode.id="js-barrage-list-parent"}let isRemoveMsgNotice=0;function initPkg_RemoveMsgNotice(){initPkg_RemoveMsgNotice_Dom(),initPkg_RemoveMsgNotice_Func(),initPkg_RemoveMsgNotice_Set()}function initPkg_RemoveMsgNotice_Dom(){var e=document.createElement("div"),t=(e.style="position: absolute;right: 5px;top: 40px;cursor: pointer;",e.id="ex-removeMsgNotice",e.innerHTML='<label id="msg-removeNotice" style="cursor: pointer;"><input type="checkbox" />关闭角标提醒</label>',e.title="关闭角标提醒",document.getElementsByClassName("PrivateLetter-frame")[0]);t&&t.appendChild(e)}function initPkg_RemoveMsgNotice_Func(){var t=document.getElementById("msg-removeNotice");if(t){let e=t.querySelector("input");t.addEventListener("click",()=>{(1==e.checked?(isRemoveMsgNotice=1,removeMsgNotice):(isRemoveMsgNotice=0,removeMsgNoticeCanel))(),saveData_removeMsgNotice()})}}function initPkg_RemoveMsgNotice_Set(){var e=localStorage.getItem("ExSave_isRemoveMsgNotice");e&&"1"==e&&(isRemoveMsgNotice=1,removeMsgNotice(),e=document.getElementById("msg-removeNotice"))&&(e.querySelector("input").checked=!0)}function removeMsgNotice(){StyleHook_set("Ex_Style_RemoveMsgNotice",".UserInfo .Badge,.ChatLetter-PopUnread{display:none!important;}")}function removeMsgNoticeCanel(){StyleHook_remove("Ex_Style_RemoveMsgNotice")}function saveData_removeMsgNotice(){localStorage.setItem("ExSave_isRemoveMsgNotice",isRemoveMsgNotice)}function initPkg_ChangeDanmakuLengthLimit(){let e=0,t=setInterval(()=>{100<++e?clearInterval(t):null!=document.getElementsByClassName("ChatSend-txt")[0]&&(changeChatTextareaMaxLength(),clearInterval(t))},1e3)}function changeChatTextareaMaxLength(){let e;null!=(e=document.getElementsByClassName("ChatSend-button")[0])&&(e.className="ChatSend-button"),null!=(e=document.getElementsByClassName("ChatSend-txt")[0])&&(e.maxLength=e.maxLength+20)}function initPkg_RestoreYuba(){responseHook((e,t)=>-1!==e.indexOf("group/getBindGroup")?t.replace('"group_status":4','"group_status":0'):t)}function initPkg_RestoreYuba_restore(){var e=RestoreYuba_getYubaId(window.location.href),t=new URLSearchParams(window.location.search).get("exRestore");t&&e!==(t=Number(t))&&(RestoreYuba_initHook(e,t),RestoreYuba_changeDom(e,t))}function RestoreYuba_checkRedirect(){const t=RestoreYuba_getYubaId(window.location.href);t&&getYubaStatus(t).then(e=>{3002==e.status_code&&(e="https://yuba.douyu.com/discussion/4815048/posts?exRestore="+t,window.location.href=e)})}function RestoreYuba_getYubaId(e){e=e.match(/\/discussion\/(\d+)/);return e&&e[1]?e[1]:null}function RestoreYuba_initHook(r,l){const e=["web/group/head","/follow/topic","group/unfollowGroup"];function s(t){return"string"==typeof t&&e.some(e=>t.includes(e))}const a=unsafeWindow.XMLHttpRequest.prototype.open,d=unsafeWindow.XMLHttpRequest.prototype.send,c=(unsafeWindow.XMLHttpRequest.prototype.open=function(e,t,o,n,i){return"string"==typeof t&&t.includes(r)&&!s(t)&&(t=t.replace(new RegExp(r,"g"),l)),a.call(this,e,t,o,n,i)},unsafeWindow.XMLHttpRequest.prototype.send=function(e){var t=this.responseURL||this._url||"";if(!s(t))if(e&&"string"==typeof e&&e.includes(r))e=e.replace(new RegExp(r,"g"),l);else if(e&&e instanceof FormData){var o,n=new FormData;for(o of e.entries()){var i=o[0];let e=o[1];"string"==typeof e&&e.includes(r)&&(e=e.replace(new RegExp(r,"g"),l)),n.append(i,e)}e=n}return d.call(this,e)},unsafeWindow.fetch);unsafeWindow.fetch=function(e,t){let o="";if("string"==typeof e?(o=e).includes(r)&&!s(e)&&(e=e.replace(new RegExp(r,"g"),l)):e instanceof Request&&(o=e.url).includes(r)&&!s(o)&&(e=new Request(o.replace(new RegExp(r,"g"),l),e)),!s(o)&&t&&t.body)if("string"==typeof t.body&&t.body.includes(r))t.body=t.body.replace(new RegExp(r,"g"),l);else if(t.body instanceof FormData){var n,i=new FormData;for(n of t.body.entries()){var a=n[0];let e=n[1];"string"==typeof e&&e.includes(r)&&(e=e.replace(new RegExp(r,"g"),l)),i.append(a,e)}t.body=i}return c.call(unsafeWindow,e,t)}}async function RestoreYuba_changeDom(e,t){t=await getYubaAnchorInfo(t);if(t){t=t.data.generalOP[0];const n=t.avatar,i=t.nick_name;function o(){document.querySelector(".groupavatar__9mD1S .image__GNnZC").src=n,document.getElementsByClassName("groupname__BUzOM")[0].innerText=i,document.getElementsByClassName("groupdesc__b8-53")[0].innerText=i+"的鱼吧",document.title=i+"的鱼吧"}o(),new DomHook(".groupavatar__9mD1S",!1,()=>{o()})}}function getYubaAnchorInfo(e){return new Promise(t=>{fetch("https://yuba.douyu.com/wbapi/web/group/managersdetail?group_id="+e).then(e=>e.json()).then(e=>{t(e)}).catch(()=>{t(null)})})}function getYubaStatus(e){return new Promise((t,o)=>{fetch("https://yuba.douyu.com/wbapi/web/group/head?group_id="+e).then(e=>e.json()).then(e=>{t(e)}).catch(e=>{o(e)})})}const roomVipExpireDayLimit=5;function initPkg_RoomVip(){setRoomVipExpireDays()}function initPkg_RoomVip_Dom(){var e=document.createElement("span"),t=(e.className="room-vip",e.innerHTML=`
  ...
  </div>`);var e=document.getElementById("ex-removeDanmakuBackground");const t=e.querySelector(".FilterSwitchStatus-status"),o=e.querySelector(".FilterSwitchStatus-switch");e.addEventListener("click",()=>{(isRemoveDanmakuBackground=!isRemoveDanmakuBackground)?(removeDanmakuBackground(),t.className=t.className.replace("is-noChecked","is-checked"),t.textContent="已开启",o.className=o.className.replace("is-noChecked","is-checked")):(StyleHook_remove("Ex_Style_RemoveDanmakuBackground"),t.className=t.className.replace("is-checked","is-noChecked"),t.textContent="未开启",o.className=o.className.replace("is-checked","is-noChecked")),saveRemoveDanmakuBackground()})}function getLocalIsRemoveDanmakuBackground(){var e=localStorage.getItem("ExSave_isRemoveDanmakuBackground");return!!e&&1===Number(e)}function saveRemoveDanmakuBackground(){localStorage.setItem("ExSave_isRemoveDanmakuBackground",isRemoveDanmakuBackground?1:0)}function removeDanmakuBackground(){StyleHook_set("Ex_Style_RemoveDanmakuBackground",`
      .danmuItem-a8616a {
  ...
  `)}isRemoveDanmakuBackground&&removeDanmakuBackground();let isRemoveDanmakuImage=getLocalIsRemoveDanmakuImage();function initPkg_Shield_RemoveDanmakuImage(){document.getElementsByClassName("ShieldTool-list")[0].insertAdjacentHTML("beforeend",`
  ...
  `)}let isRemoveEnterBarrage=getLocalIsRemoveEnterBarrage();function initPkg_Shield_RemoveEnter(){var e=document.getElementsByClassName("FilterKeywords")[0],t=window.CSS&&window.CSS.supports&&window.CSS.supports("--enter-display","none");let o=document.getElementById("js-barrage-extend-container");if(null!=e&&t){e.insertAdjacentHTML("afterbegin",`<div class="FilterSwitchStatus" id="ex-removeEnterBarrage">
    <h3>屏蔽进场弹幕</h3>
    <div>
  ...
  </div>`),isRemoveEnterBarrage?o&&o.style.setProperty("--enter-display","none","important"):o&&o.style.setProperty("--enter-display","block","important");t=document.getElementById("ex-removeEnterBarrage");const n=t.querySelector(".FilterSwitchStatus-status"),i=t.querySelector(".FilterSwitchStatus-switch");t.addEventListener("click",()=>{(isRemoveEnterBarrage=!isRemoveEnterBarrage)?(o&&o.style.setProperty("--enter-display","none","important"),n.className=n.className.replace("is-noChecked","is-checked"),n.textContent="已开启",i.className=i.className.replace("is-noChecked","is-checked")):(o&&o.style.setProperty("--enter-display","block","important"),n.className=n.className.replace("is-checked","is-noChecked"),n.textContent="未开启",i.className=i.className.replace("is-checked","is-noChecked")),saveRemoveEnterBarrage()})}}function getLocalIsRemoveEnterBarrage(){var e=localStorage.getItem("ExSave_isRemoveEnterBarrage");return!!e&&1===Number(e)}function saveRemoveEnterBarrage(){localStorage.setItem("ExSave_isRemoveEnterBarrage",isRemoveEnterBarrage?1:0)}let isRemoveRepeatedDanmaku=getLocalIsRemoveRepeatedDanmaku(),repeatedDanmakuSeconds=getLocalRepeatedDanmakuSeconds(),isEnlargeDanmaku=getLocalIsEnlargeDanmaku(),repeatedDanmakuMap={},repeatedDanmakuUuidMap={},repeatedDanmakuDomMap={},repeatedDanmakuCountMap={},repeatedDanmakuOriginalFontSizeMap=new WeakMap,repeatedDanmakuCleanupTimer=null,repeatedDanmakuDomHook=null;function initPkg_Shield_RemoveRepeatedDanmaku(){document.getElementsByClassName("FilterKeywords")[0].insertAdjacentHTML("afterbegin",`<div class="FilterSwitchStatus" id="ex-removeRepeatedDanmaku">
    <h3>屏蔽重复弹幕</h3>
    <div>
  ...
  <p class="FilterKeywords-intelligentText" style="display: flex; align-items: center;justify-content: space-between;">
  ...
  </p>`);var e=document.getElementById("ex-removeRepeatedDanmaku");const t=e.querySelector(".FilterSwitchStatus-status"),o=e.querySelector(".FilterSwitchStatus-switch"),n=document.getElementById("ex-repeatedDanmakuSeconds"),i=document.getElementById("ex-enlargeDanmaku");n.addEventListener("click",e=>{e.stopPropagation()}),i.addEventListener("click",e=>{e.stopPropagation()}),n.addEventListener("input",()=>{let e=parseInt(n.value);isNaN(e)||e<1?(e=1,n.value=1):300<e&&(e=300,n.value=300),setLocalRepeatedDanmakuSeconds(repeatedDanmakuSeconds=e),isRemoveRepeatedDanmaku&&(repeatedDanmakuDomHook&&(repeatedDanmakuDomHook.closeHook(),repeatedDanmakuDomHook=null),stopRepeatedDanmakuCleanupTimer(),removeRepeatedDanmaku())}),i.addEventListener("change",()=>{setLocalIsEnlargeDanmaku(isEnlargeDanmaku=i.checked)}),e.addEventListener("click",()=>{(isRemoveRepeatedDanmaku=!isRemoveRepeatedDanmaku)?(removeRepeatedDanmaku(),t.className=t.className.replace("is-noChecked","is-checked"),t.textContent="已开启",o.className=o.className.replace("is-noChecked","is-checked")):(repeatedDanmakuDomHook&&(repeatedDanmakuDomHook.closeHook(),repeatedDanmakuDomHook=null),stopRepeatedDanmakuCleanupTimer(),StyleHook_remove("Ex_Style_RemoveRepeatedDanmaku"),StyleHook_remove("Ex_Style_RemoveRepeatedDanmaku_Count"),t.className=t.className.replace("is-checked","is-noChecked"),t.textContent="未开启",o.className=o.className.replace("is-checked","is-noChecked")),saveRemoveRepeatedDanmaku()})}function initPkg_Shield_RemoveRepeatedDanmaku_ScriptHook(){scriptHook({url:"/firstqueue",callback:e=>{let t=e;return t=t.replace("e.display=new e.renderer(e);","e.display=new e.renderer(e);e.display.raw.comment=e;")}})}function removeRepeatedDanmaku(){StyleHook_set("Ex_Style_RemoveRepeatedDanmaku_Count",`
    /* 弹幕计数显示样式 */
    ...
    `,document.getElementById("js-player-dialog"));t.insertBefore(e,t.childNodes[0])}function Camera_isHidden(){var e=localStorage.getItem("ExSave_Camera_Hidden");return!!e&&(e=parseInt(e),Date.now()<e)}function initPkg_VideoTools_Camera_Func(){var e=getValidDom([".layout-Player-video",".layout-Player-videoEntity"]),t=document.getElementsByClassName("room-Player-Box")[0];let o=document.getElementById("ex-camera");var n=document.getElementById("ex-camera-close");let i=null,a=0,r=0,l,s=0,d=!1;n.addEventListener("click",e=>{e.stopPropagation(),confirm("是否7天内不再显示？")?localStorage.setItem("ExSave_Camera_Hidden",Date.now()+6048e5):d=!0,o.style.display="none"}),Camera_isHidden()||(e.addEventListener("mouseenter",()=>{d||Camera_isHidden()||(o.style.display="flex",s=setTimeout(()=>{o.style.display="none"},2e3))}),t.addEventListener("mousemove",()=>{d||Camera_isHidden()||(o.style.display="flex",clearTimeout(s),s=setTimeout(()=>{o.style.display="none"},2e3))}),o.addEventListener("mouseenter",()=>{d||Camera_isHidden()||(o.style.display="flex",clearTimeout(s))}),e.addEventListener("mouseleave",()=>{o.style.display="none",clearTimeout(s)}),t.addEventListener("mouseleave",()=>{o.style.display="none",clearTimeout(s)}),o.addEventListener("mousedown",e=>{"ex-camera-close"!==e.target.id&&(r=(new Date).getTime(),camera_canvas_img.width=liveVideoNode.videoWidth,camera_canvas_img.height=liveVideoNode.videoHeight,camera_canvas_img.getContext("2d").drawImage(liveVideoNode,0,0,camera_canvas_img.width,camera_canvas_img.height),l=camera_canvas_img.toDataURL("image/png"),i=new GIF({workers:5,quality:3,width:camera_width,height:camera_height,workerScript:gifworkerBlob}),cameraAddFrame(liveVideoNode,camera_canvas,i,camera_fps),a=setInterval(()=>{cameraAddFrame(liveVideoNode,camera_canvas,i,camera_fps)},camera_fps))}),o.addEventListener("mouseup",e=>{var t;"ex-camera-close"!==e.target.id&&(e=(new Date).getTime(),clearInterval(a),800<=e-r?(showMessage("【录制】正在生成gif...","info"),i.on("finished",e=>{var t=document.createElement("a"),e=(t.href=URL.createObjectURL(e),t.download=`【${camera_anchorName}】`+dateFormat("yyyy-MM-dd hh-mm-ss",new Date),document.body.appendChild(t),document.createEvent("MouseEvents"));e.initEvent("click",!1,!1),t.dispatchEvent(e),document.body.removeChild(t)}),i.render()):((e=document.createElement("a")).download=`【${camera_anchorName}】`+dateFormat("yyyy-MM-dd hh-mm-ss",new Date),e.href=l,document.body.appendChild(e),(t=document.createEvent("MouseEvents")).initEvent("click",!1,!1),e.dispatchEvent(t),document.body.removeChild(e)))}))}function initPkg_VideoTools_Camera_Video(){let e=setInterval(()=>{null!=(liveVideoNode=document.getElementsByTagName("demand-video")[0].shadowRoot.getElementById("__video"))&&liveVideoNode.videoWidth&&(clearInterval(e),camera_anchorName=document.getElementsByTagName("demand-video-anchor")[0].shadowRoot.querySelector(".anchor-name").innerText,camera_width=.25*liveVideoNode.videoWidth,camera_height=.25*liveVideoNode.videoHeight,(camera_canvas=document.createElement("canvas")).width=camera_width,camera_canvas.height=camera_height,(camera_canvas_img=document.createElement("canvas")).width=liveVideoNode.videoWidth,camera_canvas_img.height=liveVideoNode.videoHeight,initPkg_VideoTools_Camera_Video_Dom(),initPkg_VideoTools_Camera_Video_Func())},1e3)}function initPkg_VideoTools_Camera_Video_Dom(){Camera_Video_insertIcon()}function Camera_Video_insertIcon(){var e=document.createElement("div"),t=(e.id="ex-camera",e.title="单击截图 长按录制gif",e.innerHTML=`
    ...
    `;const t=document.createElement("input");t.type="number",t.step="0.1",t.min="0.1",t.value="1",t.style.cssText=`
        ...
        font-size: 12px;
        outline: none;
    `,t.addEventListener("change",()=>{var e=parseFloat(t.value);threshold=isNaN(e)||e<=0?1:e,t.value=threshold.toFixed(1)});var o=document.createElement("div"),n=(o.className="xg-icon",o.innerHTML=`
    ...
    `,document.createElement("div")),o=(n.className="status-indicator",n.style.cssText=`
        color: #fff;
        margin-right: 8px;
        font-size: 12px;
        min-width: 40px;
        text-align: center;
    `,e.appendChild(t),e.appendChild(o),e.appendChild(n),document.getElementsByClassName("left-d3671e")[0]||document.getElementsByClassName("left-bfab3b")[0]);o&&o.childNodes[4]?o.insertBefore(e,o.childNodes[4]):o.appendChild(e)}function initPkg_VideoTools_FrameChase_Func(){var e=document.querySelector("#ex-framechase-container .xg-icon");e&&e.addEventListener("click",toggleFrameChase)}let isChasing=!1,chaseInterval=null;const FAST_SPEED=2,NORMAL_SPEED=1;let threshold=1;function toggleFrameChase(){((isChasing=!isChasing)?startFrameChase:stopFrameChase)()}function startFrameChase(){const o=document.querySelector("#ex-framechase-container .status-indicator");var e=document.querySelector("#ex-framechase-container .xg-icon");let n=0;e.querySelector(".xgplayer-icon").style.background="rgba(0,255,0,0.2)",e.querySelector(".xgplayer-icon").style.boxShadow="0 0 6px rgba(0,255,0,0.3)",chaseInterval=setInterval(()=>{var e,t=liveVideoNode.buffered;0!==t.length&&(t=t.end(t.length-1)-liveVideoNode.currentTime,500<(e=Date.now())-n&&(o.textContent=t.toFixed(1)+"s",n=e),t>threshold?liveVideoNode.playbackRate=FAST_SPEED:liveVideoNode.playbackRate=NORMAL_SPEED)},200)}function stopFrameChase(){clearInterval(chaseInterval);var e=document.querySelector("#ex-framechase-container .status-indicator"),t=document.querySelector("#ex-framechase-container .xg-icon");liveVideoNode.playbackRate=NORMAL_SPEED,e&&(e.textContent=""),t.querySelector(".xgplayer-icon").style.background="rgba(255,255,255,0.1)",t.querySelector(".xgplayer-icon").style.boxShadow="none"}let currentBrightness="",currentContrast="",currentSaturate="",liveVideoParentClassName="",isMirror=!1,rotateAngle=0,isEnhanceQuality=!1,transformCss={rotateY:"",rotate:"",scale:""},panorama=null;function isEdgeBrowser(){return/Edg/i.test(navigator.userAgent)}function initPkg_VideoTools_Filter(){liveVideoParentClassName=liveVideoNode.parentNode.className,initPkg_VideoTools_Filter_Dom(),initPkg_VideoTools_Filter_Func()}function initPkg_VideoTools_Filter_Dom(){Filter_insertIcon(),isEdgeBrowser()&&Filter_insertEnhanceModal()}function Filter_insertIcon(){var e=document.createElement("div");e.id="ex-filter",e.innerHTML=`
    ...
    `;let t=getValidDom([".right-e7ea5d",".right-17e251"]);t.insertBefore(e,t.childNodes[0]),t=document.getElementsByClassName("menu-da2a9e")[0];e=document.createElement("li"),e.id="filter__panorama",e.innerText="全景",t.insertBefore(e,t.childNodes[1]),e=document.createElement("li"),e.id="filter__mirror",e.innerText="镜像画面",t.insertBefore(e,t.childNodes[1]),e=document.createElement("li"),e.id="filter__rotate",e.innerText="旋转画面",t.insertBefore(e,t.childNodes[1]),e=document.createElement("li"),e.id="filter__reset",e.innerText="重置",t.insertBefore(e,t.childNodes[1]),e=document.createElement("div");e.className="divider-f9d33d",t.insertBefore(e,t.childNodes[1])}function Filter_insertEnhanceModal(){let e=document.createElement("div");e.className="enhance-modal__panel-wrap",e.innerHTML=`
    ...
    `;let t=document.getElementsByClassName("left-d3671e")[0];t?(e.style.marginLeft="20px",t.insertBefore(e,t.childNodes[3])):(e.style.marginLeft="8px",(t=getValidDom([".left-bfab3b"])).insertBefore(e,t.childNodes[2]))}function initPkg_VideoTools_VideoSync_Func(){document.getElementById("ex-videosync").addEventListener("click",()=>{setVideoSync()})}function setVideoSync(){var e=liveVideoNode.buffered;0!=e.length&&(liveVideoNode.currentTime=e.end(0))}var isInput=!1;let videotools_num=0;function initPkg_VideoTools(){let e=setInterval(()=>{getValidDom([".right-e7ea5d",".right-17e251"])&&(clearInterval(e),liveVideoNode=document.querySelector(".layout-Player-videoEntity video"),document.getElementsByClassName("disable-23f484")[0].innerHTML="DouyuEx_"+curVersion,initPkg_VideoTools_Module(),initPkg_VideoTools_Func()),100<=++videotools_num&&clearInterval(e)},1500)}function initPkg_VideoTools_Module(){initPkg_VideoTools_Joysound(),initPkg_VideoTools_VideoSpeed(),initPkg_VideoTools_Cinema(),initPkg_VideoTools_VideoSync(),initPkg_VideoTools_FrameChase(),initPkg_VideoTools_VideoRecall(),initPkg_VideoTools_Filter(),initPkg_VideoTools_Camera(),initPkg_VideoTools_VideoZoom(),initPkg_VideoTools_MetaData()}function initPkg_VideoTools_Func(){document.getElementById("js-player-toolbar").addEventListener("mouseover",()=>{document.getElementsByClassName("filter__wrap")[0].style.display="none"}),document.getElementById("js-player-asideMain").addEventListener("mouseover",()=>{document.getElementsByClassName("filter__wrap")[0].style.display="none"}),getValidDom([".inputView-2a65aa",".inputView-620ab7"]).addEventListener("focus",()=>{isInput=!0}),getValidDom([".inputView-2a65aa",".inputView-620ab7"]).addEventListener("blur",()=>{isInput=!1});new DomHook(".app-f0f9c7",!1,e=>{0<e.length&&(0<e[0].addedNodes.length?isInput=!0:0<e[0].removedNodes.length&&(isInput=!1))})}let videoScale=1;var VideoZoom_wheelHandler=null,VideoZoom_moveHandler=null,VideoZoom_upHandler=null,VideoZoom_drag=null;function initPkg_VideoTools_VideoZoom(){let a=getValidDom([".layout-Player-videoEntity",".layout-Player-video"]),r=document.getElementsByClassName("layout-Player-videoEntity")[0],l=0,s=0;a&&r&&(r.style.transformOrigin="0 0",r.style.transition="transform 0.1s",VideoZoom_wheelHandler&&window.removeEventListener("wheel",VideoZoom_wheelHandler,!0),VideoZoom_wheelHandler=t=>{if(t.ctrlKey&&(a=a||getValidDom([".layout-Player-videoEntity",".layout-Player-video"]),r=r||document.getElementsByClassName("layout-Player-videoEntity")[0],a)&&r){var o=a.getBoundingClientRect();if(!(t.clientX<o.left||t.clientX>o.right||t.clientY<o.top||t.clientY>o.bottom)){t.preventDefault(),t.stopImmediatePropagation();var n=t.clientX-o.left,o=t.clientY-o.top;let e=videoScale+(t.deltaY<0?.1:-.1);e<.1&&(e=.1);var t=(n-l)/videoScale,i=(o-s)/videoScale;l=n-t*e,s=o-i*e,(videoScale=e)<.1&&(videoScale=.1),r.style.transform=`translate(${l}px, ${s}px) scale(${videoScale})`}}},window.addEventListener("wheel",VideoZoom_wheelHandler,{capture:!0,passive:!1}),VideoZoom_moveHandler&&window.removeEventListener("mousemove",VideoZoom_moveHandler,!0),VideoZoom_upHandler&&window.removeEventListener("mouseup",VideoZoom_upHandler,!0),window.addEventListener("mousedown",e=>{var t;e.ctrlKey&&0===e.button&&(t=a.getBoundingClientRect(),e.clientX<t.left||e.clientX>t.right||e.clientY<t.top||e.clientY>t.bottom||(e.preventDefault(),r.style.transition="none",VideoZoom_drag={x:e.clientX,y:e.clientY,tx:l,ty:s}))},!0),VideoZoom_moveHandler=e=>{VideoZoom_drag&&(l=VideoZoom_drag.tx+(e.clientX-VideoZoom_drag.x),s=VideoZoom_drag.ty+(e.clientY-VideoZoom_drag.y),r.style.transform=`translate(${l}px, ${s}px) scale(${videoScale})`)},VideoZoom_upHandler=()=>{VideoZoom_drag&&(VideoZoom_drag=null,r.style.transition="transform 0.1s")},window.addEventListener("mousemove",VideoZoom_moveHandler,!0),window.addEventListener("mouseup",VideoZoom_upHandler,!0))}function initPkg_VolumeMouseScrolling(){const t=setInterval(()=>{var e=document.querySelector(".volume-07c230");const o=document.getElementById("__video2");e&&o&&(clearInterval(t),e.addEventListener("wheel",function(e){e.preventDefault(),e.stopPropagation();var t=o.volume;VolumeMouseScrolling_Handler(e.deltaY<0?Math.min(t+.05,1):Math.max(t-.05,0))},{passive:!1,capture:!0}),o.addEventListener("volumechange",()=>{VolumeMouseScrolling_SyncVolumeUI(o.volume)}),VolumeMouseScrolling_SyncVolumeUI(o.volume))},500)}function VolumeMouseScrolling_SyncVolumeUI(e){try{var t=document.querySelector(".volume-07c230"),o=document.querySelector(".volume-bar-93f0b0 .front-99e2aa"),n=document.querySelector(".volume-bar-93f0b0 .point-6ef744"),i=document.querySelector(".volume-bar-93f0b0 .tips2-9bb064");o&&(o.style.height=100*e+"px"),n&&(n.style.bottom=100*e+7+"px"),i&&(i.textContent=`音量${Math.round(100*e)}%`),t&&(0===e?(t.classList.add("custom-muted"),t.classList.remove("custom-normal")):(t.classList.add("custom-normal"),t.classList.remove("custom-muted")))}catch(e){}}function VolumeMouseScrolling_Handler(o){var e=document.getElementById("__video2");if(e){e.muted=0===o,e.volume=o;try{["volume_muted_before_key","player_storage_volume_h5p_room"].forEach(e=>{var t=localStorage.getItem(e);t&&((t=JSON.parse(t)).v=o,localStorage.setItem(e,JSON.stringify(t)))})}catch(e){}}}function initPkg_WeeklyPanel(){isShowWeeklyPanel()&&(initPkg_WeeklyPanel_Dom(),initPkg_WeeklyPanel_Func())}function initPkg_WeeklyPanel_Dom(){var e=document.createElement("div"),t=(e.className="weeklypanel__panel-wrap",e.innerHTML=`
