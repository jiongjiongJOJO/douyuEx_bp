...
// ==/UserScript==
"use strict";function init(){initPkg_ShowDanmakuOriginAction(),initScriptHook(),initPkg_Night_Set_Fast(),initResponseHook(),initPkg_ShowDanmaku(),initKillP2P(),initFullScreen(),initHighestVideoQuality(),removeAD(),initPkg_Statistics(),initPkg_Console(),initPkg_Menu(),initPkg_FollowList()}function initPkg(){Update_checkVersion(),initPkg_DanmakuTail(),initPkg_ReturnOldWeb(),initPkg_Night(),initPkg_ExIcon(),initPkg_ExPanel(),initPkg_RealAudience(),initPkg_CopyRealLive(),initPkg_AudioLine(),initPkg_RemoveAD(),initPkg_Shield(),initPkg_BagInfo(),initPkg_Update(),initPkg_Fkbuff(),initPkg_Monitor(),initPkg_Lottery(),initPkg_PopupPlayer(),initPkg_LiveTool(),initPkg_VideoTools(),initPkg_ExpandTool(),initPkg_Refresh(),initPkg_BarrageLoop(),initPkg_FansContinue(),initPkg_Sign(),initPkg_BarragePanel(),initPkg_AccountList(),initPkg_ChatTools(),initPkg_MonthCost(),initPkg_RoomVip(),initPkg_WeeklyPanel(),initPkg_DanmakuCollect(),initPkg_RestoreYuba(),initPkg_ChangeDanmakuLengthLimit(),initPkg_CheckAnchorPocket()}function initPkg_Timer(){initPkg_LevelTask_Timer(),initPkg_Sign_OPFOY_Timer(),initPkg_DisableCloseJump_Timer()}function initTimer(){initPkg_Timer()}function initStyles(){var e=document.createElement("style");e.appendChild(document.createTextNode(`#ex-accountList-wrap {
    left: -152px;
    top: -16px;
    /* max-height: 330px;
    overflow-y: scroll;
